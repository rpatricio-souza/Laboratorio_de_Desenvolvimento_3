...
//==============================================================================
// Função que exibe/oculta a borda quando clicar na imagem da moldura
function exibeBorda(idBorda, exibir){
  idBorda.object3D.visible=exibir;
};
//==============================================================================
...
//(seleção do objeto        +    aguardar até que ele seja clicado)  
  ...
  let borda = document.querySelector("#borda1");
  
  //Deixa a imagem visível/invisível ao clicar sobre a moldura
...
//(seleção do objeto        +    aguardar até que ele seja clicado)  
  ...
  let borda = document.querySelector("#borda2");
...
//(seleção do objeto        +    aguardar até que ele seja clicado)  
  ...
  let borda = document.querySelector("#borda3");
...
//(seleção do objeto        +    aguardar até que ele seja clicado)  
  ...
  if (counter2 >= 3 ) {
    ...
    //if (counter2 == 4) {
      ...
      setTimeout(function(){
        exibeBorda(document.getElementById("borda1"),false);
        exibeBorda(document.getElementById("borda2"),false);
        exibeBorda(document.getElementById("borda3"),false);
        exibeBorda(document.getElementById("borda4"),false);
